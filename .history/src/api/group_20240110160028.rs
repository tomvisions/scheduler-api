...
use crate::{models::group::Group, repository::group::GroupDatabase, AppStatem, schema::{CreateNoteSchema, FilterOptions, UpdateNoteSchema}, };
//use actix_web::{delete, get, patch, post, web, HttpResponse, Responder};


#[post("/group")]
pub async fn create_group( body: web::Json<Group>, data: web::Data<AppState>) -> HttpResponse {
   // println!("hello");
   // println!("{}", data.title);
