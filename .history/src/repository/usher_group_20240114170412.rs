...
use crate::models::usher_group::{UsherGroupModel, UsherGroupModelResponse, CreateUsherGroupSchema};
...
impl UsherGroupDatabase {
    pub async fn create_group(group: web::Json<CreateUsherGroupSchema>, data:web::Data<AppState>) -> Result<UsherGroupResponse, Error> {  //impl Responder {
